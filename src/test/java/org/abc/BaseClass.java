...
public class BaseClass {
	...
	public static void Loadurl(String urls) {
		d.get(urls);

	}
	static WebElement element;
	public static WebElement elementFind(String ids,String value) {
		switch (ids) {
		case "id":
	...
	public static String excelRead(String path,String sheet,int rownum,int cellno) throws IOException {
	...
	public static void screenshot() throws IOException {
		...
		File des=new File("E:\\screen\\photo.png");
